...
export function BottomNav() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 bg-slate-900 border-t border-slate-700 px-2 py-3 shadow-2xl z-50">
        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`text-xs transition-all ${isActive ? "text-green-400 font-semibold" : "text-slate-400"
                  }`}
              >
                {tab.label}
              </span>
